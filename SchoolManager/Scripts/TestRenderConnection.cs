...
{
    private static string RenderConnectionString =>
        Environment.GetEnvironmentVariable("ConnectionStrings__DefaultConnection")
        ?? Environment.GetEnvironmentVariable("DATABASE_URL")
        ?? throw new InvalidOperationException(
            "Defina ConnectionStrings__DefaultConnection o DATABASE_URL (cadena Npgsql / URL de Render).");
    ...
    public static async Task<bool> TestConnectionAsync()
    {
        try
        {
            ...
            Console.WriteLine("📡 Usando ConnectionStrings__DefaultConnection o DATABASE_URL del entorno.");
